  ...
  useEffect(() => {
    const getDataAndInvoice = async () => {
      try {
        ...
        const customersData = customerRes.data.farmers || [];
        ...
        if (invoiceData) {
          setDocumentType(invoiceData.documentType || (invoiceData.gstEnabled ? "gst_invoice" : "order"));
          setFormData({
            farmerId: invoiceData.farmer?._id || invoiceData.farmer,
            rateType: invoiceData.rateType || "Rate A",
            invoiceDate: invoiceData.createdAt ? invoiceData.createdAt.slice(0, 10) : today,
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <p className="mb-2 text-xs font-black uppercase tracking-[0.25em] text-indigo-600">
            Cloudify — Invoice Settings
          </p>
          <h1 className="text-3xl font-black tracking-tight text-slate-950 sm:text-4xl">
            {gstEnabled ? "Edit GST Invoice" : "Edit Order (Kaccha Bill)"}
          </h1>
          <p className="mt-3 max-w-2xl text-sm font-medium leading-6 text-slate-600">
            Modify invoice details and save to update dynamic balances and ledgers.
          </p>
        </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className={`text-[10px] font-semibold ${gstEnabled ? "text-blue-100" : "text-slate-400"}`}>
                    GST-INV-XXXX series
                  </p>
                </div>
              </button>
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className={`text-[10px] font-semibold ${!gstEnabled ? "text-orange-100" : "text-slate-400"}`}>
                    ORD-XXXX series
                  </p>
                </div>
              </button>
              ...
              {formData.products.map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`mt-4 grid grid-cols-2 gap-3 rounded-2xl bg-white p-3 ${gstEnabled ? "sm:grid-cols-5" : "sm:grid-cols-4"}`}>
                      <div>
                        <p className="text-[10px] font-black uppercase tracking-widest text-slate-500">
                          Sq Ft
                        </p>
